   ...
   class exitTransController 
   {
      ...
      public function submit_exit_trans()
      {
         if ($_SERVER['REQUEST_METHOD'] === "POST") {
            ...
            $this->exitTransModel->submit_exit_trans($SmstrSchool,$ReasonTransfer,$OthersOne,$FeelAbtTransfer,$OthersTwo,$ParentAwareness,$PrntFeelTrnsfer,$OthersThree,$txtCourseEnroll,$txtSchool,$RsnsChoosTheSchl,$OthersFour,$Regarding,$studentno);
