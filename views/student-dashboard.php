    ...
    <div class="card shadow">
        <div class="card-body">
            ...
            <div class="form-group d-none d-lg-inline">
                <div class="h4 text-capitalize text-center" data-aos="fade-left">
                ...
                <div class="h4 d-sm-flex justify-content-center" data-aos="fade-right">
                    ...
                    <div class="ml-1">
                        this is the battle cry of the CCSO at CSU Lasam.
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="text-gray-900"> 
                    Counseling and Career Services Office(formerly the Guidance and Counseling Center)
                </div>
                <div class="text-uppercase text-gray-900 font-weight-bold mb-4">
                    citizen's charter
                </div>
            </div>
            ...
            <div class="d-sm-inline-block d-md-inline-block d-lg-inline-block d-none" data-aos="fade-left">
                <div class="form-group row" data-aos="fade-left">
                    ...
                    <div class="col-sm-9">
                        : &nbsp; Counseling and Career Services Office (CCSO), Left Wing-DARP Hall, Cagayan State University-Lasam Campus
                    </div>
                    ...
                    <div class="col-sm-8">
                        : &nbsp; Primarily Students (with Faculty and Staff clients as needs arise)
                    </div>
                </div>
            </div>
            ...
            <div class="d-sm-flex flex-column">
                <div data-aos="fade-left">
                    ...
                    <div class="text-gray-900 font-weight-bold"> 
                        Information and Growth Session Service
                    </div>
                </div>
            </div>
            ...
            <div class="d-sm-inline-block d-md-inline-block d-lg-inline-block d-none" data-aos="fade-left">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        : &nbsp; Letters, Activity Sheets, Certificate of Participation and Growth Session or Information Service Logbook
                    </div>
            ...
            <div class="d-sm-flex flex-column mb-3 d-sm-none d-md-none d-lg-none" data-aos="fade-left">
                <div data-aos="fade-right">
                    <div class="text-gray-900 mb-1"> 
                        Schedule of Availability of Service <b>:</b> August-October, January- May
                    </div>
                    <div class="text-gray-900 mb-1"> 
                        Client/Customers <b>:</b> College Students
                    </div>
                    <div class="text-gray-900 mb-1"> 
                        Requirements <b>:</b> Letters, Activity Sheets, Certificate of Participation and Growth Session or Information Service Logbook
                    </div>
                    <div class="text-gray-900"> 
                        Processing Time <b>:</b> 1 hour and 48 minutes
                    </div>
                </div>
            </div>
            <!-- end  -->
            ...
            <div class="table-responsive mb-4" data-aos="fade-left">
                <table class="table table-bordered table-hover table-sm text-dark p-0">
                    <tr class="table-borderless border-0" style="opacity:0">
                        <th><div style="width:10em;"></div></th>
                        <th><div style="width:10em;"></div></th>
                        <th><div style="width:10em;"></div></th>
                        <th><div style="width:10em;"></div></th>
                        <th><div style="width:10em;"></div></th>
                    ...
                    <tr> 
                        ...
                        <td class="align-middle text-center">Ronabelle A. Ramil Guidance Counselor</td>                                                      
                    </tr>
                    <tr> 
            ...
            <div class="d-sm-inline-block d-md-inline-block d-lg-inline-block d-none" data-aos="fade-left">
                <div class="row">
                    ...
                    <label class="col-sm-3 text-gray-900 m-0"> Client/Customers </label>
                    <div class="col-sm-8">
                        : &nbsp; CSU College Students and other requesting parties (as needs arise for faculty and staff)
                    </div>
                    <label class="col-sm-3 text-gray-900"> Requirements </label>
                    <div class="col-sm-8">
                        : &nbsp; I.D, Ball pen/ Pencil, Psychological Test Manual, Psychological Test Booklets and Answer Sheets, Psychological Testing Logbook
                    </div>
                    <label class="col-sm-3 text-gray-900"> Processing Time </label>
                    <div class="col-sm-8">
                        : &nbsp; 20 minutes to 2 hours and 20 minutes
                    </div>
                </div>
            </div>
            <!-- for mobile -->
            <div class="d-sm-flex flex-column mb-3 d-sm-none d-md-none d-lg-none" data-aos="fade-left">
                <div data-aos="fade-right">
                    <div class="text-gray-900 text-justify mb-1"> 
                        Schedule of Availability of Service <b>:</b> September, November, February and April 
                    </div>
                    <div class="text-gray-900 text-justify mb-1"> 
                        Client/Customers <b>:</b> CSU College Students and other requesting parties (as needs arise for faculty and staff)
                    </div>
                    <div class="text-gray-900 text-justify mb-1"> 
                        Requirements <b>:</b> I.D, Ball pen/ Pencil, Psychological Test Manual, Psychological Test Booklets and Answer Sheets, Psychological Testing Logbook
                    </div>
                    <div class="text-gray-900"> 
                        Processing Time <b>:</b> 20 minutes to 2 hours and 20 minutes
                    </div>
                </div>
            </div>
            <!-- end -->
            <div class="table-responsive mb-3" data-aos="fade-left">
                <table class="table table-bordered table-hover table-sm text-dark">
                    <tr class="table-borderless border-top-0" style="opacity:0;">
                        <th><div style="width:10em;"></div></th>
                        <th><div style="width:10em;"></div></th>
                        <th><div style="width:10em;"></div></th>
                        <th><div style="width:10em;"></div></th>
            ...
            <div class="d-sm-flex flex-column" data-aos="fade-left">
                <div data-aos="fade-right">
                    ...
                    <div class="text-gray-900 font-weight-bold"> 
                        Employment Counseling and PRC Online Orientation
                    </div>
                </div>
            </div>
            ...
            <div class="d-sm-flex flex-column mb-3 d-sm-none d-md-none d-lg-none" data-aos="fade-left">
                <div data-aos="fade-right">
                    <div class="text-gray-900 text-justify mb-1"> 
                        Schedule of Availability of Service <b>:</b> May or June
                    </div>
                    <div class="text-gray-900 text-justify mb-1"> 
                        Client/Customers <b>:</b> CSU College Graduating Students (for employment counseling) and Graduating Students with Board Courses (for PRC Online Orientation)
                    </div>
                    <div class="text-gray-900 text-justify mb-1"> 
                        Requirements <b>:</b> Request Letter, Certificates of Appreciation for Speakers and Participation for attendees, Career Guidance Logbook
                    </div>
                    <div class="text-gray-900"> 
                        Processing Time <b>:</b> 4 hours and 17 minutes
                    </div>
                </div>
            </div>
            <!-- end -->
            ...
            <div class="d-sm-flex flex-column" data-aos="fade-left">
                <div data-aos="fade-right">
                    <div class="text-gray-900 font-weight-bold pr-5"> 
                        Counseling and Career Services
                    </div>
                    <div class="text-gray-900 font-weight-bold pr-5"> 
                        Requests for Certification of Good Moral Character
                    </div>
                </div>
            </div>
            ...
            <div class="d-sm-inline-block d-none d-md-inline-block d-none d-lg-inline-block d-none" data-aos="fade-left">
                <div class="row">
                    ...
                    <label class="col-sm-3 text-gray-900 m-0"> Client/Customers </label>
                    <div class="col-sm-8">
                        : &nbsp; Undergraduate and Graduate CSU students
                    </div>
                    <label class="col-sm-3 text-gray-900"> Requirements </label>
                    <div class="col-sm-8">
            ...
            <div class="d-sm-flex flex-column d-sm-none d-md-none d-lg-none" data-aos="fade-left">
                <div data-aos="fade-right">
                    <div class="text-gray-900 mb-1"> 
                        Schedule of Availability of Service <b>:</b> All Year Round
                    </div>
                    <div class="text-gray-900 mb-1"> 
                        Client/Customers <b>:</b> Undergraduate and Graduate CSU students
                    </div>
                    <div class="text-gray-900 mb-1"> 
                        Requirements <b>:</b> Official Receipt of Payment
                    </div>
                    <div class="text-gray-900"> 
                        Processing Time <b>:</b> 5 minutes
                    </div>
                </div>
            </div>
            <!-- end -->
