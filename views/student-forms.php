...
<div class="container-fluid p-3">
   <div class="card">
      <?php foreach ($loginController->session_studentno($_SESSION['username']) as $row) { 
                        ...
                        <table class="table table-bordered" id="table_field">
                           ...
                           <tbody>
                              ...
                              if (empty($row['f_arragement'])) {?>
                                 <tr id="table-d-none"><td class="text-center" colspan="6">No data available</td></tr>
                              <?php } else {
                           ...
                           <tbody>
                              <?php 
                                 ...
                                 if(empty($row['e_fraternity'])){?>
                                    <tr id="table-educ-d-none"><td class="text-center" colspan="6">No data available</td></tr>
                                 <?php }else{
               ...
               <div class="tab-pane fade show" id="Healthdata">
                  ...
                  <div class="card-body">
                     ...
                     <div class="d-sm-flex flex-column pr-2 pl-2 mb-4">
                        <div class="custom-checkbox">
                           <div class="custom-control">
                              <input type="checkbox" id="cDysmenorrhea" name="health_data_health_problems[]" <?php foreach($h_health_problems as $value){if($value==="Dysmenorrhea"){echo"checked";}} ?> value="Dysmenorrhea" class="custom-control-input" />
                              <label class="custom-control-label text-gray-900" for="cDysmenorrhea">
                                 Dysmenorrhea
                              </label>
                           </div>
                           <div class="custom-control">
                              <input type="checkbox" id="cHeadache" name="health_data_health_problems[]" <?php foreach($h_health_problems as $value){if($value==="Headache"){echo"checked";}} ?> value="Headache" class="custom-control-input" />
                              <label class="custom-control-label text-gray-900" for="cHeadache">
                                 Headache
                              </label>
                           </div>
                           <div class="custom-control">
                              <input type="checkbox" id="cAsthma_one" name="health_data_health_problems[]" <?php foreach($h_health_problems as $value){if($value==="Asthma"){echo"checked";}} ?> value="Asthma" class="custom-control-input" />
                        ...
                        <div class="custom-checkbox">
                           <div class="custom-control">
                              <input type="checkbox" id="cHeartproblems" name="health_data_health_problems[]" <?php foreach($h_health_problems as $value){if($value==="Heart problems"){echo"checked";}} ?> value="Heart problems" class="custom-control-input" />
                              <label class="custom-control-label text-gray-900" for="cHeartproblems">
                                 Heart problems
                              </label>
                           </div>
                           <div class="custom-control">
                              <input type="checkbox" id="cStomachache" name="health_data_health_problems[]" <?php foreach($h_health_problems as $value){if($value==="Stomachache"){echo"checked";}} ?> value="Stomachache" class="custom-control-input" />
                              <label class="custom-control-label text-gray-900" for="cStomachache">
                                 Stomachache
                              </label>
                           </div>
                           <div class="custom-control">
                              <input type="checkbox" id="cColdsFlu" name="health_data_health_problems[]" <?php foreach($h_health_problems as $value){if($value==="Colds/Flu"){echo"checked";}} ?> value="Colds/Flu" class="custom-control-input" />
                        ...
                        <div class="custom-checkbox">
                           <div class="custom-control">
                              <input type="checkbox" id="cAbdominalpain" name="health_data_health_problems[]" <?php foreach($h_health_problems as $value){if($value==="Abdominal pain"){echo"checked";}} ?> value="Abdominal pain" class="custom-control-input" />
                              <label class="custom-control-label text-gray-900" for="cAbdominalpain">
                                 Abdominal pain
                              </label>
                           </div>
                           <div class="custom-control">
                              <input type="checkbox" id="cSeizure" name="health_data_health_problems[]" <?php foreach($h_health_problems as $value){if($value==="Seizure disorders"){echo"checked";}} ?> value="Seizure disorders" class="custom-control-input" />
                              <label class="custom-control-label text-gray-900" for="cSeizure">
                                 Seizure disorders
                              </label>
                           </div>
                           <div class="custom-control">
                              <input type="checkbox" id="cEyeProblems" name="health_data_health_problems[]" <?php foreach($h_health_problems as $value){if($value==="Eye problems"){echo"checked";}} ?> value="Eye problems" class="custom-control-input" />
                     ...
                     <div class="d-sm-flex flex-column custom-checkbox mb-3">
                        <div class="flex-column">
                           <div class="custom-control custom-checkbox d-sm-flex justify-content-between">
                              <input type="checkbox" id="Agta" name="pwd_checklist_if_yes[]" value="Agta" <?php foreach ($ip_If_yes as $row_y){if($row_y==="Agta")echo"checked";} ?> class="custom-control-input pwd-disabled-indigenous" />
                              <label class="custom-control-label text-gray-900" for="Agta"> Agta </label>
                           </div>
                           <div class="custom-control custom-checkbox d-sm-flex justify-content-between">
                              <input type="checkbox" id="Malaueg" name="pwd_checklist_if_yes[]" value="Malaueg" <?php foreach ($ip_If_yes as $row_y){if($row_y==="Malaueg")echo"checked";} ?> class="custom-control-input pwd-disabled-indigenous" />
                              <label class="custom-control-label text-gray-900" for="Malaueg"> Malaueg </label>
                           </div>
                           <div class="custom-control custom-checkbox d-sm-flex justify-content-between">
                              <input type="checkbox" id="Ibanag" name="pwd_checklist_if_yes[]" value="Ibanag" <?php foreach ($ip_If_yes as $row_y){if($row_y==="Ibanag")echo"checked";} ?> class="custom-control-input pwd-disabled-indigenous" />
                              <label class="custom-control-label text-gray-900" for="Ibanag"> Ibanag </label>
                           </div>
                           <div class="custom-control custom-checkbox d-sm-flex justify-content-between">
                              <input type="checkbox" id="Yapayao" name="pwd_checklist_if_yes[]" value="Yapayao" <?php foreach ($ip_If_yes as $row_y){if($row_y==="Yapayao")echo"checked";} ?> class="custom-control-input pwd-disabled-indigenous" />
                              <label class="custom-control-label text-gray-900" for="Yapayao"> Yapayao </label>
                           </div>
                           <div class="custom-control custom-checkbox d-sm-flex justify-content-between">
                              <input type="checkbox" id="Ibatan" name="pwd_checklist_if_yes[]" value="Ibatan" <?php foreach ($ip_If_yes as $row_y){if($row_y==="Ibatan")echo"checked";} ?> class="custom-control-input pwd-disabled-indigenous" />
                              <label class="custom-control-label text-gray-900" for="Ibatan"> Ibatan </label>
                           </div>
                           <div class="custom-control custom-checkbox d-sm-flex justify-content-between">
                              <input type="checkbox" id="Itawes" name="pwd_checklist_if_yes[]" value="Itawes" <?php foreach ($ip_If_yes as $row_y){if($row_y==="Itawes")echo"checked";} ?> class="custom-control-input pwd-disabled-indigenous" />
                     ...
                     <div class="d-sm-flex justify-content-between text-gray-900">
                        <div class="form-group">
                           <div class="custom-checkbox">
                              ...
                              <div class="custom-control">
                                 <input type="checkbox" id="cAlzheimerDisease" name="pwd_checklist_chronic_illness[]" <?php foreach ($ip_chronic_illness as $crow){if($crow==="Alzheimer's Disease")echo"checked";}?> value="Alzheimer's Disease" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cAlzheimerDisease"> Alzheimer's Disease </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cArthritis" name="pwd_checklist_chronic_illness[]" <?php foreach ($ip_chronic_illness as $crow){if($crow==="Arthritis")echo"checked";}?> value="Arthritis" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cArthritis"> Arthritis </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cAsthma_two" name="pwd_checklist_chronic_illness[]" <?php foreach ($ip_chronic_illness as $crow){if($crow==="Asthma")echo"checked";}?> value="Asthma" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cAsthma_two"> Asthma </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cCancer" name="pwd_checklist_chronic_illness[]" <?php foreach ($ip_chronic_illness as $crow){if($crow==="Cancer")echo"checked";}?> value="Cancer" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cCancer"> Cancer </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cCrohnDisease" name="pwd_checklist_chronic_illness[]" <?php foreach ($ip_chronic_illness as $crow){if($crow==="Crohn Disease")echo"checked";}?> value="Crohn Disease" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cCrohnDisease"> Crohn Disease </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cCysticFibrosis" name="pwd_checklist_chronic_illness[]" <?php foreach ($ip_chronic_illness as $crow){if($crow==="Cystic Fibrosis")echo"checked";}?> value="Cystic Fibrosis" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cCysticFibrosis"> Cystic Fibrosis </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cDiabetes" name="pwd_checklist_chronic_illness[]" <?php foreach ($ip_chronic_illness as $crow){if($crow==="Diabetes")echo"checked";}?> value="Diabetes" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cDiabetes"> Diabetes </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cEpilepsy" name="pwd_checklist_chronic_illness[]" <?php foreach ($ip_chronic_illness as $crow){if($crow==="Epilepsy")echo"checked";}?> value="Epilepsy" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cEpilepsy"> Epilepsy </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cHeartDisease" name="pwd_checklist_chronic_illness[]" <?php foreach ($ip_chronic_illness as $crow){if($crow==="Heart Disease")echo"checked";}?> value="Heart Disease" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cHeartDisease"> Heart Disease </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cMitipleSclerosis" name="pwd_checklist_chronic_illness[]" <?php foreach ($ip_chronic_illness as $crow){if($crow==="Mitiple Sclerosis")echo"checked";}?> value="Mitiple Sclerosis" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cMitipleSclerosis"> Mitiple Sclerosis </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cParkinsonsDisease" name="pwd_checklist_chronic_illness[]" <?php foreach ($ip_chronic_illness as $crow){if($crow==="Parkinsons Disease")echo"checked";}?> value="Parkinsons Disease" class="custom-control-input pwd-checklist-disabilities" />
                        ...
                        <div class="form-group">
                           <div class="custom-checkbox">
                              ...
                              <div class="custom-control">
                                 <input type="checkbox" id="cAuditoryProcessingDisorder" name="pwd_checklist_learning_disability[]" <?php foreach ($ip_learning_disability as $lrow){if($lrow==="Auditory Processing Disorder")echo"checked";}?> value="Auditory Processing Disorder" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cAuditoryProcessingDisorder"> Auditory Processing Disorder </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cDyscalcuilia" name="pwd_checklist_learning_disability[]" <?php foreach ($ip_learning_disability as $lrow){if($lrow==="Dyscalcuilia")echo"checked";}?> value="Dyscalcuilia" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cDyscalcuilia"> Dyscalcuilia </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cDysgraphia" name="pwd_checklist_learning_disability[]" <?php foreach ($ip_learning_disability as $lrow){if($lrow==="Dysgraphia")echo"checked";}?> value="Dysgraphia" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cDysgraphia"> Dysgraphia </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cDyslexia" name="pwd_checklist_learning_disability[]" <?php foreach ($ip_learning_disability as $lrow){if($lrow==="Dyslexia")echo"checked";}?> value="Dyslexia" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cDyslexia"> Dyslexia </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cLanguageProcessing" name="pwd_checklist_learning_disability[]" <?php foreach ($ip_learning_disability as $lrow){if($lrow==="Language Processing")echo"checked";}?> value="Language Processing" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cLanguageProcessing"> Language Processing </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cNoneVerballearningdisabilities_" name="pwd_checklist_learning_disability[]" <?php foreach ($ip_learning_disability as $lrow){if($lrow==="None-Verbal learning disabilities")echo"checked";}?> value="None-Verbal learning disabilities" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cNoneVerballearningdisabilities_"> None-Verbal learning disabilities </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cVisualPerceptualMotorDeficit" name="pwd_checklist_learning_disability[]" <?php foreach ($ip_learning_disability as $lrow){if($lrow==="Visual Perceptual/Visual Motor Deficit")echo"checked";}?> value="Visual Perceptual/Visual Motor Deficit" class="custom-control-input pwd-checklist-disabilities" />
                                 <label class="custom-control-label" for="cVisualPerceptualMotorDeficit"> Visual Perceptual/Visual Motor Deficit </label>
                              </div>
                              <div class="custom-control">
                                 <input type="checkbox" id="cAttentionHyperactivityDisorder" name="pwd_checklist_learning_disability[]" <?php foreach ($ip_learning_disability as $lrow){if($lrow==="Attention Deficit Hyperactivity Deficit Disorder")echo"checked";}?> value="Attention Deficit Hyperactivity Deficit Disorder" class="custom-control-input pwd-checklist-disabilities" />
                              ...
                              <div class="custom-control">
                                 <input type="checkbox" id="cDyspraxia" name="pwd_checklist_learning_disability[]" <?php foreach ($ip_learning_disability as $lrow){if($lrow==="Dyspraxia")echo"checked";}?> value="Dyspraxia" class="custom-control-input pwd-checklist-disabilities" />
                        ...
                        <div class="d-sm-flex flex-column">
                           <div class="form-group">
                              <div class="custom-checkbox">
                                 ...
                                 <div class="custom-control">
                                    <input type="checkbox" id="cChataracts" name="pwd_checklist_visual_disability[]" <?php foreach ($ip_visual_disability as $vdrow){if($vdrow==="Chataracts")echo"checked";}?> value="Chataracts" class="custom-control-input pwd-checklist-disabilities" />
                                    <label class="custom-control-label" for="cChataracts"> Chataracts </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cDiabetesVisual" name="pwd_checklist_visual_disability[]" <?php foreach ($ip_visual_disability as $vdrow){if($vdrow==="Diabetes")echo"checked";}?> value="Diabetes" class="custom-control-input pwd-checklist-disabilities" />
                                    <label class="custom-control-label" for="cDiabetesVisual"> Diabetes </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cGlaumoca" name="pwd_checklist_visual_disability[]" <?php foreach ($ip_visual_disability as $vdrow){if($vdrow==="Glaumoca")echo"checked";}?> value="Glaumoca" class="custom-control-input pwd-checklist-disabilities" />
                                    <label class="custom-control-label" for="cGlaumoca"> Glaumoca </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cMacularDegeneration" name="pwd_checklist_visual_disability[]" <?php foreach ($ip_visual_disability as $vdrow){if($vdrow==="Macular Degeneration")echo"checked";}?> value="Macular Degeneration" class="custom-control-input pwd-checklist-disabilities" />
                                    <label class="custom-control-label" for="cMacularDegeneration"> Macular Degeneration </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cRetenalDetachment" name="pwd_checklist_visual_disability[]" <?php foreach ($ip_visual_disability as $vdrow){if($vdrow==="Retenal Detachment")echo"checked";}?> value="Retenal Detachment" class="custom-control-input pwd-checklist-disabilities" />
                                    <label class="custom-control-label" for="cRetenalDetachment"> Retenal Detachment </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cRetinitisPigmentosa" name="pwd_checklist_visual_disability[]" <?php foreach ($ip_visual_disability as $vdrow){if($vdrow==="Retinitis Pigmentosa")echo"checked";}?> value="Retinitis Pigmentosa" class="custom-control-input pwd-checklist-disabilities" />
                           ...
                           <div class="form-group">
                              <div class="custom-checkbox">
                                 ...
                                 <div class="custom-control">
                                    <input type="checkbox" id="cConductive" name="pwd_checklist_hearing_disability[]" <?php foreach ($ip_hearing_disability as $hdrow){if($hdrow==="Conductive Hearing Loss")echo"checked";}?> value="Conductive Hearing Loss" class="custom-control-input pwd-checklist-disabilities" />
                                    <label class="custom-control-label" for="cConductive"> Conductive Hearing Loss </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="Sensorineuaral" name="pwd_checklist_hearing_disability[]" <?php foreach ($ip_hearing_disability as $hdrow){if($hdrow==="Sensorineuaral Hearing Loss")echo"checked";}?> value="Sensorineuaral Hearing Loss" class="custom-control-input pwd-checklist-disabilities" />
                                    <label class="custom-control-label" for="Sensorineuaral"> Sensorineuaral Hearing Loss </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cMixed" name="pwd_checklist_hearing_disability[]" <?php foreach ($ip_hearing_disability as $hdrow){if($hdrow==="Mixed Hearing Loss")echo"checked";}?> value="Mixed Hearing Loss" class="custom-control-input pwd-checklist-disabilities" />
                        ...
                        <div class="d-sm-flex flex-column">
                           <div class="form-group">
                              <div class="custom-checkbox">
                                 ...
                                 <div class="custom-control">
                                    <input type="checkbox" id="cSchizophrenia" name="pwd_checklist_mental_psychosocial_disability[]" <?php foreach ($ip_mental_psychosocial as $mdrow){if($mdrow==="Schizophrenia")echo"checked";}?> value="Schizophrenia" class="custom-control-input pwd-checklist-disabilities" />
                                    <label class="custom-control-label" for="cSchizophrenia"> Schizophrenia </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cMood" name="pwd_checklist_mental_psychosocial_disability[]" <?php foreach ($ip_mental_psychosocial as $mdrow){if($mdrow==="Mood Disorder")echo"checked";}?> value="Mood Disorder" class="custom-control-input pwd-checklist-disabilities" />
                                    <label class="custom-control-label" for="cMood"> Mood Disorder </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cAnxiety" name="pwd_checklist_mental_psychosocial_disability[]" <?php foreach ($ip_mental_psychosocial as $mdrow){if($mdrow==="Anxiety Disorder")echo"checked";}?> value="Anxiety Disorder" class="custom-control-input pwd-checklist-disabilities" />
                                    <label class="custom-control-label" for="cAnxiety"> Anxiety Disorder </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cEating" name="pwd_checklist_mental_psychosocial_disability[]" <?php foreach ($ip_mental_psychosocial as $mdrow){if($mdrow==="Eating Disorder")echo"checked";}?> value="Eating Disorder" class="custom-control-input pwd-checklist-disabilities" />
                                    <label class="custom-control-label" for="cEating"> Eating Disorder </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cPersonality" name="pwd_checklist_mental_psychosocial_disability[]" <?php foreach ($ip_mental_psychosocial as $mdrow){if($mdrow==="Personality Disorder")echo"checked";}?> value="Personality Disorder" class="custom-control-input pwd-checklist-disabilities" />
                                    <label class="custom-control-label" for="cPersonality"> Personality Disorder </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cOrganicBrain" name="pwd_checklist_mental_psychosocial_disability[]" <?php foreach ($ip_mental_psychosocial as $mdrow){if($mdrow==="Organic Brain Disorder")echo"checked";}?> value="Organic Brain Disorder" class="custom-control-input pwd-checklist-disabilities" />
                           ...
                           <div class="form-group">
                              <div class="custom-checkbox">
                                 ...
                                 <div class="custom-control">
                                    <input type="checkbox" id="cDownSyndrome" name="pwd_checklist_intellectual_disability[]" <?php foreach ($ip_intellectual_disability as $idrow){if($idrow==="Down Syndrome")echo"checked";}?> value="Down Syndrome" class="custom-control-input pwd-checklist-disabilities" />
                                    <label class="custom-control-label" for="cDownSyndrome"> Down Syndrome </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cDevelopmentDelay" name="pwd_checklist_intellectual_disability[]" <?php foreach ($ip_intellectual_disability as $idrow){if($idrow==="Development Delay")echo"checked";}?> value="Development Delay" class="custom-control-input pwd-checklist-disabilities" />
                                    <label class="custom-control-label" for="cDevelopmentDelay"> Development Delay </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cPraderWilli" name="pwd_checklist_intellectual_disability[]" <?php foreach ($ip_intellectual_disability as $idrow){if($idrow==="Prader-willi Syndrome")echo"checked";}?> value="Prader-willi Syndrome" class="custom-control-input pwd-checklist-disabilities" />
                                    <label class="custom-control-label" for="cPraderWilli"> Prader-willi Syndrome </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cFetalAlchohol" name="pwd_checklist_intellectual_disability[]" <?php foreach ($ip_intellectual_disability as $idrow){if($idrow==="Fetal Alchohol Spectrum")echo"checked";}?> value="Fetal Alchohol Spectrum" class="custom-control-input pwd-checklist-disabilities" />
                     ...
                     <ol class="text-gray-900 p-3">
                        <li>
                           ...
                           <div class="d-sm-flex justify-content-between custom-checkbox">
                              <div class="flex-column">
                                 <div class="custom-control">
                                    <input type="checkbox" id="cHappay" name="interview_feel_right_now[]" value="Happy" <?php foreach ($in_how_you_feel as $hfrow) {if($hfrow==="Happy")echo"checked";} ?> class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cHappay"> Happy </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cSad" name="interview_feel_right_now[]" value="Sad" <?php foreach ($in_how_you_feel as $hfrow) {if($hfrow==="Sad")echo"checked";} ?> class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cSad"> Sad </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cExcited" name="interview_feel_right_now[]" value="Excited" <?php foreach ($in_how_you_feel as $hfrow) {if($hfrow==="Excited")echo"checked";} ?> class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cExcited"> Excited </label>
                                 </div>
                              </div>
                              <div class="flex-column">
                                 <div class="custom-control">
                                    <input type="checkbox" id="cFine" name="interview_feel_right_now[]" value="Fine" <?php foreach ($in_how_you_feel as $hfrow) {if($hfrow==="Fine")echo"checked";} ?> class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cFine"> Fine </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cStressed" name="interview_feel_right_now[]" value="Stressed" <?php foreach ($in_how_you_feel as $hfrow) {if($hfrow==="Stressed")echo"checked";} ?> class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cStressed"> Stressed </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cNervous" name="interview_feel_right_now[]" value="Nervous" <?php foreach ($in_how_you_feel as $hfrow) {if($hfrow==="Nervous")echo"checked";} ?> class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cNervous"> Nervous </label>
                                 </div>
                              </div>
                              <div class="flex-column">
                                 <div class="custom-control">
                                    <input type="checkbox" id="cTired" name="interview_feel_right_now[]" value="Tired" <?php foreach ($in_how_you_feel as $hfrow) {if($hfrow==="Tired")echo"checked";} ?> class="custom-control-input" />
                        ...
                        <li>
                           ...
                           <div class="d-sm-flex justify-content-between custom-checkbox mb-3">
                              <div class="flex-column pr-4">
                                 <div class="custom-control">
                                    <input type="checkbox" id="cQualityEducation" name="interview_why_choose_enroll_csu[]" value="Quality education" <?php foreach ($in_why_choose_csu as $cerow) {if($cerow==="Quality education")echo"checked";} ?> class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cQualityEducation"> Quality education </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cFreeTuition" name="interview_why_choose_enroll_csu[]" value="Free tuition/miscellanrous fee" <?php foreach ($in_why_choose_csu as $cerow) {if($cerow==="Free tuition/miscellanrous fee")echo"checked";} ?> class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cFreeTuition"> Free tuition/miscellanous fee </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cBrothresAndSister" name="interview_why_choose_enroll_csu[]" value="Brothres and sister are studying here" <?php foreach ($in_why_choose_csu as $cerow) {if($cerow==="Brothres and sister are studying here")echo"checked";} ?> class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cBrothresAndSister"> Brothres and sister are studying here </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cPersonalChoiceOne" name="interview_why_choose_enroll_csu[]" value="Personal Choice" <?php foreach ($in_why_choose_csu as $cerow) {if($cerow==="Personal Choice")echo"checked";} ?> class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cPersonalChoiceOne"> Personal Choice </label>
                                 </div>
                              </div>
                              <div class="flex-column">
                                 <div class="custom-control">
                                    <input type="checkbox" id="cSchoolNearResident" name="interview_why_choose_enroll_csu[]" value="The school is near in our resident" <?php foreach ($in_why_choose_csu as $cerow) {if($cerow==="The school is near in our resident")echo"checked";} ?> class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cSchoolNearResident"> The school is near in our resident </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cParentsChoice" name="interview_why_choose_enroll_csu[]" value="Parent's choice" <?php foreach ($in_why_choose_csu as $cerow) {if($cerow==="Parent's choice")echo"checked";} ?> class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cParentsChoice"> Parent's choice </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cInterviewInfluenceFriends" name="interview_why_choose_enroll_csu[]" value="Influence of friends" <?php foreach ($in_why_choose_csu as $cerow) {if($cerow==="Influence of friends")echo"checked";} ?> class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cInterviewInfluenceFriends"> Influence of friends </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cCourseWantOffered" name="interview_why_choose_enroll_csu[]" value="The course that I want is offered here only" <?php foreach ($in_why_choose_csu as $cerow) {if($cerow==="The course that I want is offered here only")echo"checked";} ?> class="custom-control-input" />
                        ...
                        <li>
                           ...
                           <div class="d-sm-flex justify-content-between custom-checkbox">
                              <div class="flex-column">
                                 <div class="custom-control">
                                    <input type="checkbox" id="cParentsChoiceTwo" name="interview_why[]" <?php foreach ($in_why as $wrow) {if($wrow==="Parents's choice")echo"checked";} ?> value="Parents's choice" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cParentsChoiceTwo"> Parents's choice </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cPersonalChoice" name="interview_why[]" <?php foreach ($in_why as $wrow) {if($wrow==="Personal choice")echo"checked";} ?> value="Personal choice" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cPersonalChoice"> Personal choice </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cPeerInfluence" name="interview_why[]" <?php foreach ($in_why as $wrow) {if($wrow==="Peer influence")echo"checked";} ?> value="Peer influence" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cPeerInfluence"> Peer influence </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cHighSalary" name="interview_why[]" <?php foreach ($in_why as $wrow) {if($wrow==="High Salary")echo"checked";} ?> value="High Salary" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cHighSalary"> High Salary </label>
                                 </div>
                              </div>
                              <div class="flex-column">
                                 <div class="custom-control">
                                    <input type="checkbox" id="cInDemandAboard" name="interview_why[]" <?php foreach ($in_why as $wrow) {if($wrow==="In demand aboard")echo"checked";} ?> value="In demand aboard" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cInDemandAboard"> In demand aboard </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cInlineWithInterest" name="interview_why[]" <?php foreach ($in_why as $wrow) {if($wrow==="In line with interest")echo"checked";} ?> value="In line with interest" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cInlineWithInterest"> In line with interest </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cChildhoodDream" name="interview_why[]" <?php foreach ($in_why as $wrow) {if($wrow==="Childhood Dream")echo"checked";} ?> value="Childhood Dream" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cChildhoodDream"> Childhood Dream </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cSkillRelated" name="interview_why[]" <?php foreach ($in_why as $wrow) {if($wrow==="Skill related")echo"checked";} ?> value="Skill related" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cSkillRelated"> Skill related </label>
                                 </div>
                              </div>
                              <div class="flex-column">
                                 <div class="custom-control">
                                    <input type="checkbox" id="cAppealGranted" name="interview_why[]" <?php foreach ($in_why as $wrow) {if($wrow==="Appeal granted")echo"checked";} ?> value="Appeal granted" class="custom-control-input" />
                        ...
                        <li>
                           ...
                           <div class="d-sm-flex justify-content-between custom-checkbox">
                              <div class="flex-column pr-3">
                                 <div class="custom-control">
                                    <input type="checkbox" id="cParents" name="interview_problems_concerns[]" <?php foreach ($in_problems_concerns as $pcrow) {if($pcrow==="Parents")echo"checked";} ?> value="Parents" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cParents"> Parents </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cProfessors" name="interview_problems_concerns[]" <?php foreach ($in_problems_concerns as $pcrow) {if($pcrow==="Professors")echo"checked";} ?> value="Professors" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cProfessors"> Professors </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cRelatives" name="interview_problems_concerns[]" <?php foreach ($in_problems_concerns as $pcrow) {if($pcrow==="Relatives")echo"checked";} ?> value="Relatives" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cRelatives"> Relatives </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cBoyfriendGirlfriend" name="interview_problems_concerns[]" <?php foreach ($in_problems_concerns as $pcrow) {if($pcrow==="Boyfriend/girlfriend")echo"checked";} ?> value="Boyfriend/girlfriend" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cBoyfriendGirlfriend"> Boyfriend/girlfriend </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cGuidanceCounselor" name="interview_problems_concerns[]" <?php foreach ($in_problems_concerns as $pcrow) {if($pcrow==="Guidance Counselor")echo"checked";} ?> value="Guidance Counselor" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cGuidanceCounselor"> Guidance Counselor </label>
                                 </div>
                              </div>
                              <div class="d-flex flex-column">
                                 <div class="custom-control">
                                    <input type="checkbox" id="cSiblingsBrotherSisters" name="interview_problems_concerns[]" <?php foreach ($in_problems_concerns as $pcrow) {if($pcrow==="Siblings (brother/ sisters)")echo"checked";} ?> value="Siblings (brother/ sisters)" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cSiblingsBrotherSisters"> Siblings (brother/ sisters) </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cCollegeDeans" name="interview_problems_concerns[]" <?php foreach ($in_problems_concerns as $pcrow) {if($pcrow==="College Deans")echo"checked";} ?> value="College Deans" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cCollegeDeans"> College Deans </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cBoardMates" name="interview_problems_concerns[]" <?php foreach ($in_problems_concerns as $pcrow) {if($pcrow==="Board mates")echo"checked";} ?> value="Board mates" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cBoardMates"> Board mates </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cFriends" name="interview_problems_concerns[]" <?php foreach ($in_problems_concerns as $pcrow) {if($pcrow==="Friends")echo"checked";} ?> value="Friends" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cFriends"> Friends </label>
                                 </div>
                                 <div class="custom-control">
                                    <input type="checkbox" id="cNoOne" name="interview_problems_concerns[]" <?php foreach ($in_problems_concerns as $pcrow) {if($pcrow==="No one")echo"checked";} ?> value="No one" class="custom-control-input" />
                        ...
                        <li>
                           ...
                           <div class="d-sm-flex justify-content-between pl-3 mb-3">
                              <div class="d-flex flex-column">
                                 <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="cchallenging" name="interview_academics[]" <?php foreach ($in_academics as $acadrow) {if($acadrow==="Challenging")echo"checked";} ?> value="Challenging" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cchallenging"> Challenging </label>
                                 </div>
                              </div>
                              <div class=" d-flex flex-column">
                                 <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="cEasy" name="interview_academics[]" <?php foreach ($in_academics as $acadrow) {if($acadrow==="Easy")echo"checked";} ?> value="Easy" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cEasy"> Easy </label>
                                 </div>
                              </div>
                              <div class=" d-flex flex-column">
                                 <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="cExciting" name="interview_academics[]" <?php foreach ($in_academics as $acadrow) {if($acadrow==="Exciting")echo"checked";} ?> value="Exciting" class="custom-control-input" />
                           ...
                           <div class="d-sm-flex justify-content-between pl-3 mb-3">
                              <div class="d-flex flex-column">
                                 <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="cConsiderate" name="interview_professors[]" <?php foreach ($in_professors as $pfadrow) {if($pfadrow==="Considerate")echo"checked";} ?> value="Considerate" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cConsiderate"> Considerate </label>
                                 </div>
                              </div>
                              <div class=" d-flex flex-column">
                                 <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="cTerror" name="interview_professors[]" <?php foreach ($in_professors as $pfadrow) {if($pfadrow==="Terror")echo"checked";} ?> value="Terror" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cTerror"> Terror </label>
                                 </div>
                              </div>
                              <div class=" d-flex flex-column">
                                 <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="cExcellent" name="interview_professors[]" <?php foreach ($in_professors as $pfadrow) {if($pfadrow==="Excellent")echo"checked";} ?> value="Excellent" class="custom-control-input" />
                           ...
                           <div class="d-sm-flex justify-content-between pl-3 mb-3">
                              <div class="flex-column">
                                 <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="cServiceOrientation" name="interview_administration[]" <?php foreach ($in_administration as $admrow) {if($admrow==="Service-orientation")echo"checked";} ?> value="Service-orientation" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cServiceOrientation"> Service-orientation </label>
                                 </div>
                              </div>
                              <div class="flex-column">
                                 <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="cSupportive" name="interview_administration[]" <?php foreach ($in_administration as $admrow) {if($admrow==="Supportive")echo"checked";} ?> value="Supportive" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cSupportive"> Supportive </label>
                                 </div>
                              </div>
                              <div class="flex-column">
                                 <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="cApproachable" name="interview_administration[]" <?php foreach ($in_administration as $admrow) {if($admrow==="Approachable")echo"checked";} ?> value="Approachable" class="custom-control-input" />
                        ...
                        <li>
                           ...
                           <div class="d-sm-flex justify-content-start mb-3">
                              <div class="flex-column custom-checkbox">
                                 <div class="custom-control">
                                    <input type="checkbox" id="cWithinPhilippines" value="Find work immediately" <?php foreach ($in_plans_after_college as $pacrow) {if($pacrow==="Find work immediately")echo"checked";} ?> name="interview_plans_after_college[]" class="custom-control-input" />
                                 ...
                                 <select class="form-control border-top-0 border-left-0 border-right-0 rounded-0 shadow-none" id="cWithinPhilippines" name="interview_plans_after_college[]">
                                    <option value=""> Choose... </option>
                                    <option value="Within Philippines" <?php foreach ($in_plans_after_college as $pacrow) {if($pacrow==="Within Philippines")echo"selected";} ?>> Within Philippines </option>
                                    <option value="Abroad" <?php foreach ($in_plans_after_college as $pacrow) {if($pacrow==="Abroad")echo"selected";} ?>> Abroad </option>
                                 </select>
                                 <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="cEnrollGraduateStudies" name="interview_plans_after_college[]" <?php foreach ($in_plans_after_college as $pacrow) {if($pacrow==="Enroll in graduate studies")echo"checked";} ?> value="Enroll in graduate studies" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cEnrollGraduateStudies"> Enroll in graduate studies </label>
                                 </div>
                                 <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="cReviewExamination" name="interview_plans_after_college[]" <?php foreach ($in_plans_after_college as $pacrow) {if($pacrow==="Review and take the board examination")echo"checked";} ?> value="Review and take the board examination" class="custom-control-input" />
                                    <label class="custom-control-label text-gray-900" for="cReviewExamination"> Review and take the board examination </label>
                                 </div>
                                 <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="cPutUpBusiness" name="interview_plans_after_college[]" <?php foreach ($in_plans_after_college as $pacrow) {if($pacrow==="Put up my own business")echo"checked";} ?> value="Put up my own business" class="custom-control-input" />
